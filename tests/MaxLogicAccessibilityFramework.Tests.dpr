...
uses
  ...
  DUnitX.TestRunner,
  MaxLogic.Accessibility.AgentBridge.PipeServer.Tests in 'src\MaxLogic.Accessibility.AgentBridge.PipeServer.Tests.pas',
  ...
  MaxLogic.Accessibility.ProviderConstruction.Tests in 'src\MaxLogic.Accessibility.ProviderConstruction.Tests.pas',
